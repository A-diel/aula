...
function preload(){
   muñe=loadAnimation("depre.png","depr.png");
  jumpSound = loadSound("jump.wav")
  collidedSound = loadSound("collided.wav")
  
  backgroundImg = loadImage("selva.webp")
 ...
 // groundImage.scale=11;
  ...
  obstacle1.scale=0.4;
  obstacle2 = loadImage("piedra.png");
...
function setup() {
  ...
  muñeco=createSprite(80,height-150,20,50);
  muñeco.addAnimation("muñe",muñe);
  muñeco.scale=0.7
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    ground.velocityX = -(6 + 3*score/100);
    cloudsGroup.setLifetimeEach(13);
    if((touches.length > 0 || keyDown("SPACE")) && trex.y  >= height-120) {
      jumpSound.play( )
      trex.velocityY = -10;
       touches = [];
    }
    text("*DEPRECION*",10,400);
    stroke("yellow");
    fill("yellow");
    text.scale=9
